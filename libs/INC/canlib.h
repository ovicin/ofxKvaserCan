...
#define canHWTYPE_BAGEL              64  ///< Code name "Bagel" for now
#define canHWTYPE_MINIPCIE           66  ///< "Mini PCI Express" for now
/** @} */
 ...
 * \ingroup General
 * 
 * Reading and writing customer data works with Kvaser Leaf (of all
 * types), Kvaser USBcan Professional, Kvaser Memorator Professional and
 * Kvaser Memorator Light.
 * 
 * \param[in]  hnd        An open handle to a CAN channel.
 * \param[in]  userNumber Assigned by Kvaser.
 * \param[in]  itemNumber Must be zero (presently not implemented)
