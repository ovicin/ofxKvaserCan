...
ofxKvaserCan::ofxKvaserCan(){
}
////////////////////////////////////////////////////////////////////////////////////
//Function that prints the "help- menu"
////////////////////////////////////////////////////////////////////////////////////
void ofxKvaserCan::help(void)
{
  printf("\n********************************************\n*\n"); 
...
//////////////////////////////////////////////////////////////////////////////////////
void ofxKvaserCan::printDriverConfig( void )
{
  unsigned int i;
...
// Set bus parameters 
////////////////////////////////////////////////////////////////////////////////////
void ofxKvaserCan::InitDriver(void)
{
  int  i;
  int  stat;
...
//////////////////////////////////////////////////
void ofxKvaserCan::Cleanup(void)
{
  unsigned int i;
  int          stat;
...
//////////////////////////////////////////////////////////////////////////////
canStatus ofxKvaserCan::TransmitMessage(unsigned int   Id,	unsigned char *inmsg, BOOL print)
{
  unsigned char msg[8];
  int           i;
  for (i=0;i<8;i++) msg[i]=inmsg[i];
  ...
  if (print) {
    ...
    printf("Time:%u Ch:%u ID:%08x DLC:%u Flg:%02x            Data:",canReadTimer(0),
...
void  ofxKvaserCan::ReadMessage(void)
{
long id;
...
int  Quiet = 0; 
                ...
                // Read a message.
                //
                stat = canRead(m_DriverConfig->channel[0].hnd, &id, msg, &dlc, &flags, &time);
                if (stat == canOK && (Quiet <= 1)) {
					printf("  Received Message");
                    if ((flags & canMSG_ERROR_FRAME) == 0) {
                        // A message.
                        // Print identifier and flags.
                        printf( "%8lu%c%c%c%c  %02lu ",
                                id,
                                flags & canMSG_EXT        ? 'x' : ' ',
                                flags & canMSG_RTR        ? 'R' : ' ',
                    ...
                    if ((flags & canMSG_RTR) == 0) {
                        for (i=0; i < ((dlc > 8)? 8: dlc); i++) printf("%3u ", msg[i]);
                        for (; i<8; i++) printf( "    ");
                    } else {
                        printf( "                                ");
                    }
